...
class RolePlay(BaseAgent):
    ...
    def _run(self,
        ...
        # only openai interface support function calling, so for other llm, 
        # we need to concat the function information to the prompt and use chat_with_raw_prompt
